...
void BaseProject::handleGamePad(int id, glm::vec3& m, glm::vec3& r, bool& fire, bool& start) {
...
void BaseProject::getSixAxis(float& deltaT, glm::vec3& m, glm::vec3& r, bool& fire, bool& start) {
